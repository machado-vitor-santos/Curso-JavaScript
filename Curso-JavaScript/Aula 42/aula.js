...
// DOM é basicamento todo HTML que está dentro de uma página

// seleciona o elemento pelo ID
document.getElementByid("maia-signature").innerText = `Olá meu nome é jfniwjehrijwernwjernkwejrnwer`;
